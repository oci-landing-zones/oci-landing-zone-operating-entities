...
The OCI Open LZ is built on top of the official OCI Landing Zone modules (IAM, networking, security, observability, and governance), which are officially supported OCI resource modules. 
