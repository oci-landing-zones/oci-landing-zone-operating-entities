...
Use the magic button provided in the summary section to deploy the HPC LZ extension using [OCI Resource Manager (ORM)](/../../../commons/content/orm.md) or use [Terraform CLI](../../../commons/content/terraform.md).
