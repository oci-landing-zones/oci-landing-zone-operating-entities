# Language Workload Zone Extension <!-- omit from toc -->
...
|                           |                                                                                                                                                                |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **DEPLOYMENT NAME**              | Language Landing Zone Workload Extension                                                                                                                                    |
...
For configuring and running the One-OE Landing Zone language services extension Identity Layer use the following JSON file: [language_identity.auto.tfvars.json](/workload-extensions/ai-services/language/language_identity.auto.tfvars.json) You can customize this configuration to fit your exact OCI IAM topology.
...
-var-file ../terraform-oci-open-lz/workload-extensions/ai-services/language/language_identity.auto.tfvars.json
```
