# Document Understanding Workload Extension <!-- omit from toc -->
...
| **IAM CONFIGURATION**     | [doc_identity.auto.tfvars.json](/workload-extensions/ai-services/document-understanding/doc_identity.auto.tfvars.json) |
...
For configuring and running the One-OE Landing Zone document-understanding services extension Identity Layer use the following JSON file: [doc_identity.auto.tfvars.json](/workload-extensions/ai-services/document-understanding/doc_identity.auto.tfvars.json) You can customize this configuration to fit your exact OCI IAM topology.
...
-var-file ../terraform-oci-open-lz/workload-extensions/ai-services/document-understanding/doc_identity.auto.tfvars.json
```
