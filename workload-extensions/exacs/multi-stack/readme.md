...
| **Network pre configuration - Hub E**</br> [exacs_network_uc1_e_pre.json](exacs_network_uc1_e_pre.json) | • ExaDB-D VCN, database subnet, backup subnet, NAT gateway, route table, security list and service gateway before hub DRG routing is ready | vcn-fra-lz-shared-exacs <br><br> sn-fra-lz-shared-exacs-db, sn-fra-lz-shared-exacs-backup <br><br> ngw-fra-lz-shared-exacs <br><br> rt-fra-lz-shared-exacs-generic <br><br> sl-fra-lz-shared-exacs-generic <br><br> sgw-fra-lz-shared-exacs |
| **Network configuration - Hub A**</br> [exacs_network_uc1_a.json](exacs_network_uc1_a.json) | • ExaDB-D VCN network after hub DRG routing is ready, with the default route through the DRG and firewalled hub | vcn-fra-lz-shared-exacs <br><br> sn-fra-lz-shared-exacs-db, sn-fra-lz-shared-exacs-backup <br><br> rt-fra-lz-shared-exacs-generic <br><br> sl-fra-lz-shared-exacs-generic <br><br> sgw-fra-lz-shared-exacs |
| **Network configuration - Hub E**</br> [exacs_network_uc1_e.json](exacs_network_uc1_e.json) | • ExaDB-D VCN network after hub DRG routing is ready, with the default route through the local NAT gateway and DRG routes to the hub and peer spokes | vcn-fra-lz-shared-exacs <br><br> sn-fra-lz-shared-exacs-db, sn-fra-lz-shared-exacs-backup <br><br> ngw-fra-lz-shared-exacs <br><br> rt-fra-lz-shared-exacs-generic <br><br> sl-fra-lz-shared-exacs-generic <br><br> sgw-fra-lz-shared-exacs |
