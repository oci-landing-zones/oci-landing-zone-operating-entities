...
| Deployment | Use the files listed below with Terraform CLI, or stage them in a private Object Storage bucket or approved private source for OCI Resource Manager. Configure outputs and dependencies because pre-existing resources are used. To learn more about this, go [here](../../../commons/content/orm_bp.md). | [Blueprint Factory required](../../../addons/oci-lz-blueprint-factory/README.md) | [Blueprint Factory required](../../../addons/oci-lz-blueprint-factory/README.md) |
