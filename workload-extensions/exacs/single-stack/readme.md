...
| **Security configuration** for</br> **CIS v1 Step 1**: [exacs_security_cis1_uc1_pre.json](exacs_security_cis1_uc1_pre.json)</br> and</br> **CIS v1 Step 2**: [exacs_security_cis1_uc1.json](exacs_security_cis1_uc1.json)</br></br> **CIS v2 Step 1**: [exacs_security_cis2_uc1_pre.json](exacs_security_cis2_uc1_pre.json)</br> and</br> **CIS v2 Step 2**: [exacs_security_cis2_uc1.json](exacs_security_cis2_uc1.json) | • Cloud Guard target</br> • Security Zone recipes and targets</br> • Vulnerability scanning resources</br> • CIS v2 Vault and key resources | **Common**: cg-tgt-root, sz-rcp-lz-01-cis-l1, sz-rcp-lz-02-cis-l2, sz-rcp-lz-03-shared-network, sz-rcp-lz-04-environment-network, sz-rcp-lz-05-workload, vss-rcph-lz, vss-tgth-lz <br><br> **Step 2 only**: security zone targets for network and workload compartments <br><br> **CIS v1 only**: sz-tgt-lz-cis-l1 <br><br> **CIS v2 only**: key-lz-shared-oss-audit-bkt, sz-tgt-lz-cis-l2, vlt-lz-shared-security |
...
Published generated artifacts in this folder currently cover UC1. UC2 and UC3 are retained as design guidance and require the [OCI LZ Blueprint Factory](../../../addons/oci-lz-blueprint-factory/README.md) before use.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>ORM</td>
      <td><strong>CIS v1 Step 1</strong><br><a href='https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/oci-landing-zones/terraform-oci-modules-orchestrator/archive/refs/tags/v2.1.3.zip&amp;zipUrlVariables={"input_config_files_urls":"https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_governance_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_identity_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_network_hub_e.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_observability_cis1_uc1_pre.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_security_cis1_uc1_pre.json"}'><img src="../../../commons/images/DeployToOCI_onestack.svg" height="30" align="center"></a><br>Files: <a href="./exacs_governance_uc1.json">governance</a>, <a href="./exacs_identity_uc1.json">iam</a>, <a href="./exacs_network_hub_e.json">network</a>, <a href="./exacs_observability_cis1_uc1_pre.json">observability CIS v1 Step 1</a>, <a href="./exacs_security_cis1_uc1_pre.json">security CIS v1 Step 1</a><br>Step 2: replace <a href="./exacs_observability_cis1_uc1_pre.json">observability CIS v1 Step 1</a> with <a href="./exacs_observability_cis1_uc1.json">observability CIS v1 Step 2</a> and <a href="./exacs_security_cis1_uc1_pre.json">security CIS v1 Step 1</a> with <a href="./exacs_security_cis1_uc1.json">security CIS v1 Step 2</a> after network resources exist.<br><br><strong>CIS v2 Step 1</strong><br><a href='https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/oci-landing-zones/terraform-oci-modules-orchestrator/archive/refs/tags/v2.1.3.zip&amp;zipUrlVariables={"input_config_files_urls":"https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_governance_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_identity_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_network_hub_e.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_observability_cis2_uc1_pre.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacs/single-stack/exacs_security_cis2_uc1_pre.json"}'><img src="../../../commons/images/DeployToOCI_onestack.svg" height="30" align="center"></a><br>Files: <a href="./exacs_governance_uc1.json">governance</a>, <a href="./exacs_identity_uc1.json">iam</a>, <a href="./exacs_network_hub_e.json">network</a>, <a href="./exacs_observability_cis2_uc1_pre.json">observability CIS v2 Step 1</a>, <a href="./exacs_security_cis2_uc1_pre.json">security CIS v2 Step 1</a><br>Step 2: replace <a href="./exacs_observability_cis2_uc1_pre.json">observability CIS v2 Step 1</a> with <a href="./exacs_observability_cis2_uc1.json">observability CIS v2 Step 2</a> and <a href="./exacs_security_cis2_uc1_pre.json">security CIS v2 Step 1</a> with <a href="./exacs_security_cis2_uc1.json">security CIS v2 Step 2</a> after network resources exist.</td>
    ...
    <tr>
      <td>Terraform CLI</td>
      <td></td>
      <td>Use the same configuration files listed in the ORM row with Terraform CLI. Apply the security and observability Step 1 (`*_pre.json`) files first, then re-apply with the Step 2 files after network resources exist. For command examples and prerequisites, see <a href="../../../commons/content/terraform.md">Run with Terraform CLI</a>.</td>
    </tr>
  </tbody>
</table>
