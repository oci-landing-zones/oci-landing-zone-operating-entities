...
| **Security configuration**</br> **CIS v1 pre**: [exacs_security_cis1_uc1_pre.json](exacs_security_cis1_uc1_pre.json)</br> **CIS v1 final**: [exacs_security_cis1_uc1.json](exacs_security_cis1_uc1.json)</br> **CIS v2 pre**: [exacs_security_cis2_uc1_pre.json](exacs_security_cis2_uc1_pre.json)</br> **CIS v2 final**: [exacs_security_cis2_uc1.json](exacs_security_cis2_uc1.json) | • Cloud Guard target</br> • Security Zone recipes and targets</br> • Vulnerability scanning resources</br> • CIS v2 Vault and key resources | **Common**: cg-tgt-root, sz-rcp-lz-02-shared-network, sz-rcp-lz-03-prod-environment, vss-rcph-lz, vss-tgth-lz <br><br> **Final security only**: sz-tgt-lz-shared-network, sz-tgt-lz-prod-environment <br><br> **CIS v1 only**: sz-rcp-lz-01-cis-l1, sz-tgt-lz-cis-l1 <br><br> **CIS v2 only**: key-lz-shared-oss-audit-bkt, sz-rcp-lz-01-cis-l2, sz-tgt-lz-cis-l2, vlt-lz-shared-security |
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Files: <a href="./exacs_governance_uc1.json">governance</a>, <a href="./exacs_identity_uc1.json">iam</a>, <a href="./exacs_network_hub_e.json">network</a>, <a href="./exacs_observability_cis1_uc1_pre.json">observability CIS v1 pre</a>, <a href="./exacs_security_cis1_uc1_pre.json">security CIS v1 pre</a><br>
        Final re-apply: replace <a href="./exacs_observability_cis1_uc1_pre.json">observability CIS v1 pre</a> with <a href="./exacs_observability_cis1_uc1.json">observability CIS v1</a> and <a href="./exacs_security_cis1_uc1_pre.json">security CIS v1 pre</a> with <a href="./exacs_security_cis1_uc1.json">security CIS v1</a> after network resources exist.<br><br>
        ...
        Files: <a href="./exacs_governance_uc1.json">governance</a>, <a href="./exacs_identity_uc1.json">iam</a>, <a href="./exacs_network_hub_e.json">network</a>, <a href="./exacs_observability_cis2_uc1_pre.json">observability CIS v2 pre</a>, <a href="./exacs_security_cis2_uc1_pre.json">security CIS v2 pre</a><br>
        Final re-apply: replace <a href="./exacs_observability_cis2_uc1_pre.json">observability CIS v2 pre</a> with <a href="./exacs_observability_cis2_uc1.json">observability CIS v2</a> and <a href="./exacs_security_cis2_uc1_pre.json">security CIS v2 pre</a> with <a href="./exacs_security_cis2_uc1.json">security CIS v2</a> after network resources exist.
      </td>
    ...
    <tr>
      <td>Terraform CLI</td>
      <td></td>
      <td>Use the same configuration files listed in the ORM row with Terraform CLI. Apply the `*_pre.json` security and observability files first, then re-apply with the final files after network resources exist. For command examples and prerequisites, see <a href="../../../commons/content/terraform.md">Run with Terraform CLI</a>.</td>
    </tr>
  </tbody>
</table>
