...
Published generated artifacts currently support Use Case 1 (UC1), the shared ExaDB-D platform. Use Case 2 (UC2), the hybrid ExaDB-D platform, and Use Case 3 (UC3), the dedicated ExaDB-D platform, are retained as design guidance and require the [OCI LZ Blueprint Factory](../../../addons/oci-lz-blueprint-factory/README.md) before use.
