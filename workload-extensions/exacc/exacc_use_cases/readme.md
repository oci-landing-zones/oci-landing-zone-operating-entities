...
At the global level, notification topics support shared ExaDB-C@C infrastructure and shared ExaDB-D database workloads.
...
At the shared level, event rules cover the shared ExaCC infrastructure compartment.

At the environment level, event rules cover the production and pre-production ExaCC database compartments.
