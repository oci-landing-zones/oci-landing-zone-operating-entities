...
| Use Case 2 (UC2): Hybrid ExaDB-C@C Platform<br><br><img src="./content/uc2.png" width="220"> | [Blueprint Factory required](../../addons/oci-lz-blueprint-factory/README.md) | [Blueprint Factory required](../../addons/oci-lz-blueprint-factory/README.md) |
| Use Case 3 (UC3): Dedicated ExaDB-C@C Platform<br><br><img src="./content/uc3.png" width="220"> | [Blueprint Factory required](../../addons/oci-lz-blueprint-factory/README.md) | [Blueprint Factory required](../../addons/oci-lz-blueprint-factory/README.md) |
