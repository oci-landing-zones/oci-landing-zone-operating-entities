...
| Deployment | Use the files listed below with Terraform CLI, or stage them in a private Object Storage bucket or approved private source for OCI Resource Manager. To read some best practices about how to use ORM go [here](../../../commons/content/orm_bp.md). | coming soon | coming soon |
