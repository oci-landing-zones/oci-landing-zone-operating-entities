...
| **Security configuration**</br> **CIS v1 pre**: [exacc_security_cis1_uc1_pre.json](exacc_security_cis1_uc1_pre.json)</br> **CIS v1 final**: [exacc_security_cis1_uc1.json](exacc_security_cis1_uc1.json)</br> **CIS v2 pre**: [exacc_security_cis2_uc1_pre.json](exacc_security_cis2_uc1_pre.json)</br> **CIS v2 final**: [exacc_security_cis2_uc1.json](exacc_security_cis2_uc1.json) | • Cloud Guard target</br> • Security Zone recipes and targets</br> • Vulnerability scanning resources</br> • CIS v2 Vault and key resources | **Common**: cg-tgt-root, sz-rcp-lz-02-shared-network, sz-rcp-lz-03-prod-environment, vss-rcph-lz, vss-tgth-lz <br><br> **Final security only**: sz-tgt-lz-shared-network, sz-tgt-lz-prod-environment <br><br> **CIS v1 only**: sz-rcp-lz-01-cis-l1, sz-tgt-lz-cis-l1 <br><br> **CIS v2 only**: key-lz-shared-oss-audit-bkt, sz-rcp-lz-01-cis-l2, sz-tgt-lz-cis-l2, vlt-lz-shared-security |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>ORM</td>
      <td>
        <strong>CIS v1</strong><br>
        <a href='https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/oci-landing-zones/terraform-oci-modules-orchestrator/archive/refs/tags/v2.1.1.zip&amp;zipUrlVariables={"input_config_files_urls":"https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_governance_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_identity_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_observability_cis1_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_security_cis1_uc1_pre.json"}'><img src="../../../commons/images/DeployToOCI_onestack.svg" height="30" align="center"></a><br>
        Files: <a href="./exacc_governance_uc1.json">governance</a>, <a href="./exacc_identity_uc1.json">iam</a>, <a href="./exacc_observability_cis1_uc1.json">observability CIS v1</a>, <a href="./exacc_security_cis1_uc1_pre.json">security CIS v1 pre</a><br>
        Final re-apply: replace <a href="./exacc_security_cis1_uc1_pre.json">security CIS v1 pre</a> with <a href="./exacc_security_cis1_uc1.json">security CIS v1</a> after initial resources exist.<br><br>
        <strong>CIS v2</strong><br>
        <a href='https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/oci-landing-zones/terraform-oci-modules-orchestrator/archive/refs/tags/v2.1.1.zip&amp;zipUrlVariables={"input_config_files_urls":"https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_governance_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_identity_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_observability_cis2_uc1.json,https://raw.githubusercontent.com/oci-landing-zones/oci-landing-zone-operating-entities/refs/heads/master/workload-extensions/exacc/single-stack/exacc_security_cis2_uc1_pre.json"}'><img src="../../../commons/images/DeployToOCI_onestack.svg" height="30" align="center"></a><br>
        Files: <a href="./exacc_governance_uc1.json">governance</a>, <a href="./exacc_identity_uc1.json">iam</a>, <a href="./exacc_observability_cis2_uc1.json">observability CIS v2</a>, <a href="./exacc_security_cis2_uc1_pre.json">security CIS v2 pre</a><br>
        Final re-apply: replace <a href="./exacc_security_cis2_uc1_pre.json">security CIS v2 pre</a> with <a href="./exacc_security_cis2_uc1.json">security CIS v2</a> after initial resources exist.
      </td>
    ...
    <tr>
      <td>Terraform CLI</td>
      <td></td>
      <td>Use the same configuration files listed in the ORM row with Terraform CLI. Apply the `*_security_*_pre.json` file first, then re-apply with the final security file after initial resources exist. For command examples and prerequisites, see <a href="../../../commons/content/terraform.md">Run with Terraform CLI</a>.</td>
    </tr>
  </tbody>
</table>
