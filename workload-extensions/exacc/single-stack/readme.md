...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>One-OE foundation compartments plus shared ExaDB-C@C infrastructure/database and project database compartments.<br><br>Base One-OE IAM plus Global Infra, Global DBA, and Project DBA groups and policies, including read access from each Project DBA to its hosting ACD.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>• Landing Zone and ExaDB-C@C compartments<br>• Landing Zone and ExaDB-C@C IAM groups and policies</td>
      <td>One-OE foundation compartments plus shared ExaDB-C@C infrastructure, environment database platform compartments, and project database compartments.<br><br>Base One-OE IAM plus Global Infra umbrella, environment Infra and DBA, and Project DBA groups and policies. Environment roles receive only the shared-infrastructure dependency permissions required for their VMC, AVMC, and ACD operations.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>• Events<br>• Alarms<br>• Notifications<br>• Service connector components</td>
      <td>Base One-OE observability plus shared ExaDB-C@C infrastructure events/topic and per-environment database/VMC events, alarms, and environment/project topics. The ExaDB-C@C contribution contains 8 event rules, 14 alarms, and 3 topics.<br><br>Service connector audit bucket and policy remain CIS-specific: CIS v1 sets <code>cis_level: 1</code>; CIS v2 sets <code>cis_level: 2</code> and adds <code>kms_key_id: KEY-LZ-SHARED-OSS-AUDIT-BKT-KEY</code>.</td>
    </tr>
    <tr>
      ...
      <td>• Landing Zone and ExaDB-C@C compartments<br>• Landing Zone and ExaDB-C@C IAM groups and policies</td>
      <td>One-OE foundation compartments plus environment-dedicated ExaDB-C@C infrastructure/database and project database compartments.<br><br>Base One-OE IAM plus environment Infra and DBA groups per environment and Project DBA groups and policies. No global ExaDB-C@C administration group is generated.</td>
    </tr>
    <tr>
