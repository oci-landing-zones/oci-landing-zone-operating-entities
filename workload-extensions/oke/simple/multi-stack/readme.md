...
2. **Prepare Configuration Files**
   - Download or create a ZIP file containing:
     - The [orchestrator module source](https://github.com/oci-landing-zones/terraform-oci-modules-orchestrator)
     - All four `.auto.tfvars.json` files from this directory
   - Upload the ZIP file to ORM

3. **Review Configuration Keys**
...
4. **Configure Stack Variables**
   - Set `tenancy_ocid` (usually auto-populated)
   - Set `region` (usually auto-populated)
   - The var-files will be automatically loaded
