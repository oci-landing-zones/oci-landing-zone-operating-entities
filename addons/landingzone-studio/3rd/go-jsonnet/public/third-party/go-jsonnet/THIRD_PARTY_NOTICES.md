...
The generated `libjsonnet.wasm` and committed `wasm_exec.js` contain or derive from the
following third-party software. Studio's custom `main.go` remains covered by the
...
The goyaml.v2 attribution notice supplied by the dependency is included there
as well.
