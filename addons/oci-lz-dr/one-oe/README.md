...
|---|---:|---|---|
| Hub A | 1 | [<img src="../../../commons/images/DeployToOCI.svg" height="25" align="center" alt="Deploy Hub A with CIS Level 1 to OCI">][orm-cis1-hub-a] | `oneoe_bcdr_network_hub_a_pre.json`<br>`oneoe_bcdr_observability_cis1_pre.json`<br>`oneoe_bcdr_security.json` |
| Hub A | 2 | [<img src="../../../commons/images/DeployToOCI.svg" height="25" align="center" alt="Deploy Hub A with CIS Level 2 to OCI">][orm-cis2-hub-a] | `oneoe_bcdr_network_hub_a_pre.json`<br>`oneoe_bcdr_observability_cis2_pre.json`<br>`oneoe_bcdr_security.json` |
| Hub B | 1 | [<img src="../../../commons/images/DeployToOCI.svg" height="25" align="center" alt="Deploy Hub B with CIS Level 1 to OCI">][orm-cis1-hub-b] | `oneoe_bcdr_network_hub_b_pre.json`<br>`oneoe_bcdr_observability_cis1_pre.json`<br>`oneoe_bcdr_security.json` |
| Hub B | 2 | [<img src="../../../commons/images/DeployToOCI.svg" height="25" align="center" alt="Deploy Hub B with CIS Level 2 to OCI">][orm-cis2-hub-b] | `oneoe_bcdr_network_hub_b_pre.json`<br>`oneoe_bcdr_observability_cis2_pre.json`<br>`oneoe_bcdr_security.json` |
| Hub C | 1 | [<img src="../../../commons/images/DeployToOCI.svg" height="25" align="center" alt="Deploy Hub C with CIS Level 1 to OCI">][orm-cis1-hub-c] | `oneoe_bcdr_network_hub_c_pre.json`<br>`oneoe_bcdr_observability_cis1_pre.json`<br>`oneoe_bcdr_security.json` |
| Hub C | 2 | [<img src="../../../commons/images/DeployToOCI.svg" height="25" align="center" alt="Deploy Hub C with CIS Level 2 to OCI">][orm-cis2-hub-c] | `oneoe_bcdr_network_hub_c_pre.json`<br>`oneoe_bcdr_observability_cis2_pre.json`<br>`oneoe_bcdr_security.json` |
