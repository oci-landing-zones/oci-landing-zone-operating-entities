...
|:-|:-|:-|
| <img src="../../../blueprints/one-oe/design/images/oneoe_hub_a.png" width="300"> | <img src="../../../blueprints/one-oe/design/images/oneoe_hub_b.png" width="300"> | <img src="../../../blueprints/one-oe/design/images/oneoe_hub_c.png" width="300"> |
...
The committed runtime preset remains Frankfurt/Amsterdam. For custom pairs, Blueprint Factory `--dr-config` derives both peers, regional resource names, advertised CIDRs, and route placement from the independent home and DR files; Amsterdam is not a default for custom generation.
