...
1. From the ExaDB-C@C scenario README, click the ORM deployment button for the Platform approach. The button opens a new ORM stack with the JSON files for that option preloaded.
