...
| **Compartments:** `cmp-lz-monitoring`. | **Compartments:** none; uses the existing project compartments `cmp-lz-prod-proj1` and `cmp-lz-preprod-proj1` for project-dedicated DBM/OPSI private endpoints, and the existing project compartment `cmp-lz-prod-proj1` for the monitoring agent VM. |
| **Groups:** `grp-lz-global-mon-admins`, `grp-lz-global-mon-readers`. | **Groups:** `grp-lz-prod-proj1-mon-admin`, `grp-lz-preprod-proj1-mon-admin`, `grp-lz-prod-proj1-mon-reader`, `grp-lz-preprod-proj1-mon-reader`. |
| **Policies:** `pcy-mon-services`, `pcy-global-mon-admin`, `pcy-global-mon-readers`, `pcy-mon-dynamic-group`, `pcy-global-mon-security-admin`, `pcy-global-mon-security-readers`, `pcy-global-mon-network-admin`, `pcy-global-mon-network-readers`, `pcy-prod-proj1-mon-admin`, `pcy-prod-proj1-mon-readers`, `pcy-preprod-proj1-mon-admin`, `pcy-preprod-proj1-mon-readers`. | **Policies:** `pcy-mon-services`, `pcy-mon-dynamic-group`, `pcy-prod-proj1-mon-security-admin`, `pcy-prod-proj1-mon-security-reader`, `pcy-preprod-proj1-mon-security-admin`, `pcy-preprod-proj1-mon-security-reader`, `pcy-prod-proj1-mon-network-admin`, `pcy-prod-proj1-mon-network-reader`, `pcy-preprod-proj1-mon-network-admin`, `pcy-preprod-proj1-mon-network-reader`, `pcy-prod-proj1-mon-admin`, `pcy-prod-proj1-mon-reader`, `pcy-preprod-proj1-mon-admin`, `pcy-preprod-proj1-mon-reader`. |
...
| **NSGs:** `nsg-fra-lz-hub-global-mon-pe`, `nsg-fra-lz-prod-proj1-mon-pe-db1`, `nsg-fra-lz-preprod-proj1-mon-pe-db1`. | **NSGs:** `nsg-fra-lz-prod-proj1-mon-pe-db1`, `nsg-fra-lz-preprod-proj1-mon-pe-db1`. |
...
| **Monitoring instance:** `vm-fra-lz-shared-mon-agent`. | **Monitoring instance:** `vm-fra-lz-prod-proj1-mon-agent` in `cmp-lz-prod-proj1`. |
