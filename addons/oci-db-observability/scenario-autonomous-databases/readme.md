...
| **Groups:** `grp-lz-centralized-mon-admin`, `grp-lz-centralized-mon-reader`. | **Groups:** `grp-lz-prod-proj1-mon-admin`, `grp-lz-preprod-proj1-mon-admin`. |
| **Policies:** `pcy-mon-services`, `pcy-centralized-mon-admin`, `pcy-centralized-mon-readers`, `pcy-mon-dynamic-group`, `pcy-centralized-mon-security-admin`, `pcy-centralized-mon-security-readers`, `pcy-centralized-mon-network-admin`, `pcy-centralized-mon-network-readers`, `pcy-prod-proj1-mon-admin`, `pcy-prod-proj1-mon-readers`, `pcy-preprod-proj1-mon-admin`, `pcy-preprod-proj1-mon-readers`. | **Policies:** `pcy-mon-services`, `pcy-mon-dynamic-group`, `pcy-prod-proj1-mon-security-admin`, `pcy-preprod-proj1-mon-security-admin`, `pcy-prod-proj1-mon-network-admin`, `pcy-preprod-proj1-mon-network-admin`, `pcy-prod-proj1-mon-admin`, `pcy-preprod-proj1-mon-admin`. |
