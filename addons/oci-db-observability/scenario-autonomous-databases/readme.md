...
| **Groups:** `grp-lz-global-mon-admins`, `grp-lz-global-mon-readers`. | **Groups:** `grp-lz-prod-proj1-mon-admin`, `grp-lz-preprod-proj1-mon-admin`, `grp-lz-prod-mon-reader`, `grp-lz-preprod-mon-reader`. |
| **Policies:** `pcy-mon-services`, `pcy-global-mon-admin`, `pcy-mon-dynamic-group`, `pcy-global-mon-security-admin`, `pcy-global-mon-network-admin`, `pcy-prod-proj1-mon-admin`, `pcy-preprod-proj1-mon-admin`. | **Policies:** `pcy-mon-services`, `pcy-mon-dynamic-group`, `pcy-prod-proj1-mon-security-admin`, `pcy-preprod-proj1-mon-security-admin`, `pcy-prod-proj1-mon-network-admin`, `pcy-preprod-proj1-mon-network-admin`, `pcy-prod-proj1-mon-admin`, `pcy-preprod-proj1-mon-admin`. |
