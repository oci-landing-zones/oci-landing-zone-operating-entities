...
| **Platform** | Each project team owns a dedicated compartment where it has full control. The observability team is part of the project and has access to the resources that belong to that project. | Distributes observability ownership by project. IAM policies, private endpoints, and access to monitored entities are scoped to the project compartment. |
