...
- Monitoring groups. The centralized option creates `grp-lz-global-mon-admin` and `grp-lz-global-mon-reader`. The project option uses the existing project administration groups `grp-lz-prod-proj1-admin` and `grp-lz-preprod-proj1-admin`.
