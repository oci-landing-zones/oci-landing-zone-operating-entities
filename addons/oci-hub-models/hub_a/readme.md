...
| |  |
|---|---| 
| **OPERATION** | **OP.00 Hub A Deployment** | 
| **TARGET RESOURCES**  </br></br><img src="../../../commons/images/icon_oci.jpg" width="32">| </br>This operation creates all the resources described in [Section 2](#2-components). </br>**Note** that some resources, such as Network Firewalls, incur costs.</br></br> |
| **INPUT CONFIGURATIONS** </br></br><img src="../../../commons/images/icon_json.jpg" width="30" align="center">&nbsp; +&nbsp; <img src="../../../commons/images/icon_terraform.jpg" width="32" align="center">|</br>**IAM**: [oci_open_lz_hub_a_iam.auto.tfvars.json](oci_open_lz_hub_a_iam.auto.tfvars.json) as input to the [CIS  Landing Zone IAM](https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam) module. </br>**Network**: [oci_open_lz_hub_a_network.auto.tfvars.json](oci_open_lz_hub_a_network.auto.tfvars.json) as input to the [CIS Landing Zone Network](https://github.com/oci-landing-zones/terraform-oci-modules-networking) module.</br></br> |
