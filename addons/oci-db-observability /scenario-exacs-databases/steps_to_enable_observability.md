# OCI Observability for Exadata Database Service on Dedicated Infrastructure (ExaDB-D)
...
For each Pluggable Database, go to **Oracle Database** -> **Exadata Database Service on Dedicated Infrastructure** -> **VM Clusters** -> **VM Cluster Details** -> **Database Details** -> **Pluggable Database**.
