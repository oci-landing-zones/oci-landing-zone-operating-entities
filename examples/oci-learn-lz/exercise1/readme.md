...
Your objective is to review the inital tenancy structure created by your team, containing part of the **channels** domain.
...
| 4 | Update the final tenancy structure IaC related configuration and save it as oci-learn-lz/exercise1/config-yaml/[oci_learn_lz_iam_final.yml](/examples/oci-learn-lz/exercise1/config_yaml/oci_learn_lz_iam_final.yml). |
| 5 | Proceed to Step 3. |
...
| ACTIVITY | DESCRIPTION   | 
|---|---|
| 1 | Commit to you operations git repository the new IaC iam configuration file. The image below is a high-level representations of this. |
...
Your objective is to run your new configuration with ORM. The image below now contains the automation mechanism, which is based on an ORM Stack that is linked to your configuration file(s).
