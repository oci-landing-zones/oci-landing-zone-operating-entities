...
|---|---|---| 
| ID | Description | Time | 
| **[OP. ID.01](https://github.com/paolajuarezgomez/OpenLZ/tree/master/examples/oci-ebs-lz/op01_deploy_CIS)** | Deploy CIS. Cover Core network resources ( hub VCN), Core IAM resources (compartments, group, policies), and security services | 5' configuration + 10' deployment | 
