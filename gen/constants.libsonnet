...
// OCI Realm constants. Only oc1 in scope now.
// Structure per-realm for easy future extension (oc2, oc3, etc.)
{
  oc1: {
    service_identifiers: {
      fss: 'Fssoc1Prod',
      // objectstorage prefix is region-specific, not realm-specific.
      // Format: 'objectstorage-{region}' — generated by builders using config.region
    },
