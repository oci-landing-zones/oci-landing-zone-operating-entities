{
    ...
    "service_connectors_configuration": {
        "default_compartment_id": "CMP-LZ-SECURITY-KEY",
        "buckets": {"BKT-LZ-SERVICE-CONNECTOR": {"name": "bkt-lz-service-connector", "compartment_id": "CMP-LZ-SECURITY-KEY", "cis_level": "2", "kms_key_id": "KEY-LZ-SHARED-OSS-AUDIT-BKT-KEY"}},
        "service_connectors": {
            "SCH-LZ-MONITOR-KEY": {
