...
function(hub, ip_config, spoke_route_tables, fw_nsg_key=null, has_spoke_natgw=false)
  local spokes = (import 'oneoe_spokes.libsonnet')(ip_config.mgmt_sn, ip_config.lb_sn, has_spoke_natgw);
  hub {
    network_configuration+: {
      network_configuration_categories+: {
        ...
        '1-prod': spokes._prod_category,
        '2-preprod': spokes._preprod_category,
      },
    },
  }
