{
  ...
  alarms_configuration+: {
    default_compartment_id: "CMP-LZ-SHARED-EXACC-DB-KEY",
    alarms+: {
  ...
  events_configuration+: {
    ...
    event_rules+: {
      ...
      "RUL-LZ-NOTIFICATION-PLATFORM-EXACC-INFRA-KEY": {
        "compartment_id": "CMP-LZ-SHARED-EXACC-INFRA-KEY",
        "destination_topic_ids": ["NOTT-LZ-SHARED-EXACC-INFRA-WORKLOADS-KEY"],
  ...
  notifications_configuration+: {
    ...
    topics+: {
      ...
      "NOTT-LZ-SHARED-EXACC-INFRA-WORKLOADS-KEY": {
        "compartment_id": "CMP-LZ-SECURITY-KEY",
        "description": "Topic for prod workloads notifications.",
        "name": "nott-lz-shared-exacc-infra-workloads",
      ...
      "NOTT-LZ-SHARED-EXACC-DB-WORKLOADS-KEY": {
        "compartment_id": "CMP-LZ-SECURITY-KEY",
        "description": "Topic for prod workloads notifications.",
        "name": "nott-lz-shared-exacc-db-workloads",
