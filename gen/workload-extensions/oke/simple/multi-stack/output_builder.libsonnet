...
function(profile, env_name='preprod', platform_name='oke') {
  ...
  oke_security_cis1: rendered_lz.security_cis1,
  oke_security_cis1_pre: rendered_lz.security_cis1_pre,
  oke_security_cis2: rendered_lz.security_cis2,
  oke_security_cis2_pre: rendered_lz.security_cis2_pre,
