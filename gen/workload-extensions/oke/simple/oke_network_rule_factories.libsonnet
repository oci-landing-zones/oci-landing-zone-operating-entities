...

{
  nsg: {
    ...
    udp_egress(description, dst_nsg_key, port):: nsg_egress(description, 'UDP', dst_nsg_key, dst_port(port)),
    udp_ingress(description, src_nsg_key, port):: nsg_ingress(description, 'UDP', src_nsg_key, dst_port(port)),
    udp_egress_src(description, dst_nsg_key, port):: nsg_egress(description, 'UDP', dst_nsg_key, src_port(port)),
    udp_ingress_src(description, src_nsg_key, port):: nsg_ingress(description, 'UDP', src_nsg_key, src_port(port)),
