...
// Scheme: /12 base → 4 bits OE → 2 bits Env → 3 bits VCN → 3 bits Subnet → 8 bits Host
{
  ...
  ['shared-exacs_vcn']: '10.0.24.0/21',
  ['prod-exacs_vcn']: '10.0.104.0/21',
  ['preprod-exacs_vcn']: '10.0.168.0/21',

  // --- Shared spoke subnets ---
  ['shared-exacs_db_sn']: '10.0.24.0/24',
  ['shared-exacs_db_bck_sn']: '10.0.25.0/24',
  ...
  ['prod-exacs_db_sn']: '10.0.104.0/24',
  ['prod-exacs_db_bck_sn']: '10.0.105.0/24',
  ...
  ['preprod-exacs_db_sn']: '10.0.168.0/24',
  ['preprod-exacs_db_bck_sn']: '10.0.169.0/24',
