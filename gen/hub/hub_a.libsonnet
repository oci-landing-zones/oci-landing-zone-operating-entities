...
// hub_config: { kind: 'hub_a', network: { vcn: '...', subnets: { 'fw-dmz', lb, 'fw-int', mgmt, mon, dns } } }
// vcn_list:   [{name: 'prod', cidr: '10.0.64.0/21'}, ...] — spoke VCN CIDRs for NFW policies
          ...
          '0-shared': {
            ...
            vcns: {
              [n.key('VCN', ['HUB'])]: common._hub_vcn(n, vcn_cidr, subnets, {
                ...
                route_tables: {
                  [n.key('RT', ['HUB', 'FW', 'DMZ'])]: {
                    display_name: n.display('rt', ['hub', 'fw', 'dmz']),
                    route_rules: common._internet_route_via_igw(n),
                  },

                  [n.key('RT', ['HUB', 'FW', 'INT'])]: {
                    display_name: n.display('rt', ['hub', 'fw', 'int']),
