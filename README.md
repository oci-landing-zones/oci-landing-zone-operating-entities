...
Before starting, find below the **seven characteristics** of the OCI Open LZ. For more details on the design, see the table on the next section.
...
|---|---|---|
| **ENABLEMENT** | [5 Steps 5 Minutes](https://www.youtube.com/watch?v=JWKRHfO4LnY&ab_channel=OracleLearning)</br>[A Landing Zone Blueprint to Onboard and Run OCI (60m)](https://www.youtube.com/watch?v=xbKIxSERIxY)        | These recorded sessions discusses the differences between [standard](https://github.com/oracle-devrel/technology-engineering/blob/main/landing-zones/standard_landing_zones/standard_landing_zones.md) and [tailored landing zones](https://github.com/oracle-devrel/technology-engineering/blob/main/landing-zones/tailored_landing_zones/tailored_landing_zones.md) , presenting the OCI Open LZ Blueprint tailored views, and running a demo  with Terraform configurable modules.          |
| **DESIGN** | [OCI Open LZ Design](/design/OCI_Open_LZ.pdf)</br>[ OCI Open LZ Draw.io ](/design/OCI_Open_LZ.drawio)   | Present the OCI Open LZ **blueprint design** with the functional, security, network, and operations view, with all the diagrams in a reusable format. |
| **CONFIGURE**                | [OCI Open LZ Runtime View](/examples/oci-open-lz/readme.md)                                                                                   | Operation scenarios **configurations** for running 'OP.01 Manage Shared Services' and 'OP.02 Manage OE'. These configurations are run with [OCI Open LZ Terraform Orchestrator Module ](orchestrator/Readme.md). |                
| **RUN**                | [OCI Open LZ TF Orchestrator Module ](/orchestrator/readme.md)           | This is the OCI Open LZ blueprint **automation interface**, a Terraform module that orchestrates the  [OCI CIS LZ IAM ](https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam) and the [OCI CIS LZ Network](https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-networking) Terraform Modules into a fully consolidated automation, with several resource tyoes in the same run. It supports **any OCI landing zone configuration**, including - but not limited to - the OCI Open LZ. |
