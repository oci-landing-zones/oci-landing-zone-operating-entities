...
| **CONFIGURE** | [OCI Open LZ Runtime View](/examples/oci-open-lz/readme.md) | Operations  **configurations** for running the OCI Open LZ. These configurations are run with [OCI Open LZ Terraform Orchestrator Module ](orchestrator/readme.md) on top of the [CIS  Landing Zone Enhanced Modules](https://www.ateam-oracle.com/post/cis-landing-zone-enhanced-modules) |                
