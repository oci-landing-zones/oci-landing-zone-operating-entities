...
| Enablement         | [Tailored Landing Zones](https://github.com/oracle-devrel/technology-engineering/blob/main/landing-zones/tailored_landing_zones/tailored_landing_zones.md)                | MD    | This page presents what are tailored landing zones, their use cases, and assets available.                        |
