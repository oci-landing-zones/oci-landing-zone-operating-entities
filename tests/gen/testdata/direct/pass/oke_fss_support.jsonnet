...

{
  ...
  fss_worker_ingress_rule_count: std.length(std.objectFields(fss_nsg.ingress_rules)),
  fss_worker_egress_rule_count: std.length(std.objectFields(fss_nsg.egress_rules)),
