...
- `gen/workload-extensions/ocvs/AGENTS.md` plus `gen/workload-extensions/ocvs/simple/*` are the source of truth for config-driven `ocvs_simple` behavior, OCVS network prerequisites, and generated `ocvs_configuration` semantics in this repo.
