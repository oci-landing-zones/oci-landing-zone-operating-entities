...
| [**Multi-OE**](/blueprints/multi-oe) | [<img src="../commons/images/multi-oe_icon.jpg" width="100" height="value">](/blueprints/multi-oe/generic_v1/design/images/3_security_view_tenancy_l1-l2.jpg)| **L** | Onboards **[multiple](/blueprints/multi-oe) Operating Entities** with a shared services model, with OE-dedicated environments, platforms, and projects, sharing **one tenancy.** | Several OUs, LoBs, OpCos, or Departments.
