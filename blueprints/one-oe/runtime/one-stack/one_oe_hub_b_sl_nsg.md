...
| <img src="../../design/images/nsg.png"  height="100" align="center"> | **Network Security Group** with Ingress and Egress rules, associated with the OCI Network Firewall and public Load Balancer, and configured to be associated with workloads when they are onboarded to the respective Spoke VCN tiers. </br>The diagram uses the exact NSG naming convention defined in the JSON configuration templates. |
