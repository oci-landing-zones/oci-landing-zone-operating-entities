## **[One-OE + Hub B: Security Lists and Network Security Groups](#)**
### Overview
...
- In the [One-OE + Hub B deployment](https://github.com/oci-landing-zones/oci-landing-zone-operating-entities/blob/master/blueprints/one-oe/runtime/one-stack/one_oe_hub_b.md), stateless rules are configured only on NSGs associated with the Network Firewalls and Load Balancers within the Hub VCN. All other Security Lists and NSGs are configured with stateful rules.
