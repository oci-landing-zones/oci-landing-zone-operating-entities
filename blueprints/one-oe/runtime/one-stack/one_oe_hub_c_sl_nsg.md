...
### The diagram represents the Security List and NSG configuration for the [One-OE + Hub C deployment](https://github.com/oci-landing-zones/oci-landing-zone-operating-entities/blob/master/blueprints/one-oe/runtime/one-stack/one_oe_hub_c.md)
