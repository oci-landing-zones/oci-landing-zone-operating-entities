## **[One-OE + Hub C: Security Lists and Network Security Groups](#)**
### Overview
...
#### The diagram represents the Security List and NSG rule configuration for the [One-OE + Hub C deployment](https://github.com/oci-landing-zones/oci-landing-zone-operating-entities/blob/master/blueprints/one-oe/runtime/one-stack/one_oe_hub_c.md)

&nbsp;
<img src="../../design/images/sl_nsg_hub_c.png" width="980" height="value">

&nbsp;

| Legend           | Description                                                                                                       |
|--------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| <img src="../../design/images/sl.png"  height="100" align="center"> | **Security List** with **Ingress** and **Egress** rules. </br>The diagram uses the exact SL naming convention defined in the JSON configuration templates. |
| <img src="../../design/images/nsg.png"  height="100" align="center"> | **Network Security Group** with **Ingress** and **Egress** rules.  </br>The diagram uses the exact NSG naming convention defined in the JSON configuration templates. |
...
- In the [One-OE + Hub C deployment](https://github.com/oci-landing-zones/oci-landing-zone-operating-entities/blob/master/blueprints/one-oe/runtime/one-stack/one_oe_hub_c.md), stateless rules are configured only on NSGs associated with the Network Load Balancers, Network Firewalls and Public Load Balancers within the Hub VCN. All other Security Lists and NSGs are configured with stateful rules.
