...
| `AL-LZ-COMPUTE-VM-UNRESPONSIVE-KEY` | `al-lz-compute-vm-unresponsive` | The instance is not responding to the accessibility probe | Workload compute and storage | `oci_compute_instance_health` | CRITICAL | `PT2M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-FILE-SYSTEM-ANOMALY-KEY` | `al-lz-compute-file-system-anomaly` | The instance health service detected a file-system issue | Workload compute and storage | `oci_compute_instance_health` | CRITICAL | `PT1M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-INFRASTRUCTURE-ISSUE-KEY` | `al-lz-compute-infrastructure-issue` | OCI reported an infrastructure issue for the instance | Workload compute and storage | `oci_compute_infrastructure_health` | CRITICAL | `PT2M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-BARE-METAL-DEFECT-KEY` | `al-lz-compute-bare-metal-defect` | OCI reported a bare-metal health defect | Workload compute and storage | `oci_compute_infrastructure_health` | CRITICAL | `PT1M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-MAINTENANCE-SCHEDULED-KEY` | `al-lz-compute-maintenance-scheduled` | OCI reported scheduled maintenance | Workload compute and storage | `oci_compute_infrastructure_health` | WARNING | `PT1M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-CPU-WARNING-KEY` | `al-lz-compute-cpu-warning` | Mean CPU utilization is at least 75% | Workload compute and storage | `oci_computeagent` | WARNING | `PT10M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-CPU-CRITICAL-KEY` | `al-lz-compute-cpu-critical` | Mean CPU utilization is at least 90% | Workload compute and storage | `oci_computeagent` | CRITICAL | `PT5M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-MEMORY-WARNING-KEY` | `al-lz-compute-memory-warning` | Mean memory utilization is at least 75% | Workload compute and storage | `oci_computeagent` | WARNING | `PT10M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-COMPUTE-MEMORY-CRITICAL-KEY` | `al-lz-compute-memory-critical` | Mean memory utilization is at least 90% | Workload compute and storage | `oci_computeagent` | CRITICAL | `PT5M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
| `AL-LZ-BLOCK-VOLUME-THROTTLED-IO-KEY` | `al-lz-block-volume-throttled-io` | One or more volume operations were throttled | Workload compute and storage | `oci_blockstore` | CRITICAL | `PT1M` | `NOTT-LZ-SECURITY-KEY` | Disabled |
