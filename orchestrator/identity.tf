...
module "cislz_compartments" {
  source                     = "git@github.com:oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//compartments?ref=v0.1.5"
...
module "cislz_groups" {
  source               = "git@github.com:oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//groups?ref=v0.1.5"
  tenancy_ocid         = var.tenancy_ocid
...
module "cislz_dynamic_groups" {
  source                       = "git@github.com:oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//dynamic-groups?ref=v0.1.5"
  tenancy_ocid                 = var.tenancy_ocid
...
module "cislz_policies" {
  source                 = "git@github.com:oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//policies?ref=v0.1.5"
  tenancy_ocid           = var.tenancy_ocid
