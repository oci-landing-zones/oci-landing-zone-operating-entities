...
module "cislz_compartments" {
  source                     = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//compartments?ref=v0.1.6"
...
module "cislz_groups" {
  source               = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//groups?ref=v0.1.6"
  tenancy_ocid         = var.tenancy_ocid
...
module "cislz_dynamic_groups" {
  source                       = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//dynamic-groups?ref=v0.1.6"
  tenancy_ocid                 = var.tenancy_ocid
...
module "cislz_policies" {
  source                 = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//policies?ref=v0.1.6"
  tenancy_ocid           = var.tenancy_ocid
